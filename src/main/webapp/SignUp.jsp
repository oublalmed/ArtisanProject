            ...
            <div class="content-bottom" id="Clientform" style=" display: block;">
                <form action="LoginServlet" method="post">
                    <div class="field-group">
                        ...
                        <div class="wthree-field">
                            <input name="username" id="nomcl" type="text" value="" placeholder="First name " required>
                        </div>
                    </div>
                    <div class="field-group">
                        <span class="fa fa-user" aria-hidden="true"></span>
                        <div class="wthree-field">
                            <input name="username" id="prenomcl" type="text" value="" placeholder="Last name" required>
                        </div>
                    </div>
                    <div class="field-group">
                        <div class="wthree-field">
                            <input name="username" id="agecl" type="date" value="" placeholder="Age" required>
                        </div>
                    </div>
                    <div class="field-group" >
                        <div class="wthree-field">
                            <input name="Email" id="emailcl" type="email" value="" placeholder="Email" required>
                        </div>
                    </div>
                    <div class="field-group">
                        <span class="fa fa-phone" aria-hidden="true"></span>
                        <div class="wthree-field">
                            <input name="username" id="telcl" type="text" value="" placeholder="phone number" required>
                        </div>
                    </div>
                    <div class="field-group">
                        &nbsp &nbsp
