...
<nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav" style="background-color: transparent">
    <div class="container">
        ...
        <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link js-scroll active" href="#">Ahmed sadiq</a>
                </li>
                <li class="nav-item">
    ...
    <div class="wrapper">
        <div class="d-grid employer-grid"
            ...
            <div class="employer-name" STYLE="display: grid;align-content: end;">
                <h4 style="font-size: 30px;color: #fff;line-height: 35px;font-weight: 300;"> Ahmed sadiq</h4>
                <p style="font-size: 16px;color: #eee;line-height: 25px;">Senior Web designer</p>
            </div>
                ...
                <div class="modal-body">
                    <form action="AddProduct" method="post">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-12">
                                <div class="form-group">
                                    <textarea name="desc" rows="5" cols="61" placeholder=" Description ..."></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-lg-12">
                                <div class="form-group">
