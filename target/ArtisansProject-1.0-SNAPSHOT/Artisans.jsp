                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="title-box text-center">
                            ...
                            <BR>
                            <form method="post" action="SearchArtisan">
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-outline-primary btn-lg"> F i l t e r</button>
                            </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="team-main-19">
                    ...
                    <div class="right-team-9">
                        <div class="sub-grid-33">
                            <h5><a href="candidate-single.html"
                                   class="title-team-33"><%=artisansList.get(i).getNomArtisan() + " " + artisansList.get(i).getPrenomArtisan() %>
                            </a>
                            </h5>
                            <p class="sm-text-33"><%=artisansList.get(i).getLibelleCat()%>
                            </p>
